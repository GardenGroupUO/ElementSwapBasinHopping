...
if sys.version_info[0] == 2:
	...
	toString += '\n'
	toString += '================================================'+'\n'
	toString += 'This is the ESBH'+'\n'
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The ESBH program requires Python3. You are attempting to execute this program in Python2.'+'\n'
	toString += 'Make sure you are running the ESBH program in Python3 and try again'+'\n'
...
if sys.version_info[1] < 4:
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The ESBH program requires Python 3.4 or greater.'+'\n'
...
if not found:
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The ESBH program requires ASE.'+'\n'
	toString += '\n'
...
if not found:
	...
	toString += '\n'
	toString += '================================================'+'\n'
	toString += 'This is the ESBH Program'+'\n'
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The ESBH requires the "packaging" program.'+'\n'
	toString += '\n'
	toString += ''+'\n'
...
if version.parse(ase.__version__) < version.parse(ase_version_minimum):
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The ESBH program requires ASE greater than or equal to '+str(ase_version_minimum)+'.'+'\n'
...
if not found:
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The ESBH program requires ASAP3.'+'\n'
	toString += '\n'
...
if not version.parse(asap3.__version__) == version.parse(asap3_version_minimum):
	...
	toString += 'Version: '+str(__version__)+'\n'
	toString += '\n'
	toString += 'The ESBH program requires ASAP3 equal to '+str(asap3_version_minimum)+'.'+'\n'
...
from ESBH_Program.Element_Swap_Basin_Hopping_Main import Element_Swap_Basin_Hopping_Main
